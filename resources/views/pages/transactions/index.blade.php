                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($transactions as $key => $item)
                                        ...
                                        <td>
                                            @if ($item->transaction_status == "PENDING")
                                                <a href="{{route('transactions.status', $item->id)}}?status=SUCCESS" class="btn btn-warning btn-sm"><i class="fa fa-check"></i></a>
                                                <a href="{{route('transactions.status', $item->id)}}?status=FAILED" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></a>
                                            @endif
                                            <a href="{{route('transactions.show', $item->id)}}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
